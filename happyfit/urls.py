...
from events.views import home, events_list, event_details, event_booking, event_booking_confirm, booking_details
...
urlpatterns = [
    ...
    path('booking/<int:id>', booking_details, name="booking_details"),
